...
const office = {
  ...
  items: [
    ...
    // ---------------- interior
    { id: 'i-demo', cat: 'int', name: 'Selective demolition — ceilings, flooring, partitions right of the entrance', qty: AREAS.officeTotal, unit: 'SF', low: 1.0, high: 1.75, included: true, notes: 'Dumpster on site already.' },
